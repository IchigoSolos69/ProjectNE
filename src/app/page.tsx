...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* 1. Hero Section */}
      <section className="relative bg-brand-sky/35 overflow-hidden transition-colors duration-300">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Hero Image Block */}
            <div className="lg:col-span-6 relative h-[350px] sm:h-[450px] lg:h-[550px] rounded-2xl overflow-hidden shadow-xl border border-brand-sky/30">
              <Image
